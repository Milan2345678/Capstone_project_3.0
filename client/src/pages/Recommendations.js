...
const Recommendations = () => {
  ...
  const getCategoryBadgeClass = (category) => {
    switch (category) {
      ...
      case "target": return "badge badge-target";
      case "dream": return "badge badge-dream";
    ...
    <div className="rc-page">
      ...
      <nav className="rc-nav">
        ...
        <div className="rc-nav-links">
          <a className="rc-nav-link" href="/">Home</a>
          <a className="rc-nav-link active" href="/recommendations">Recommendations</a>
          <a className="rc-nav-link" href="/chat">AI Chat</a>
          <a className="rc-nav-link" href="/profile">Profile</a>
        </div>
      </nav>
      ...
      <div className="rc-container">
        ...
        <div className="rc-page-header">
          ...
          <p className="rc-page-sub">Set your preferences and we'll match you with the best options.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="rc-card">
            ...
            <div className="rc-slider-labels">
              <span className={`rc-slider-lbl ${collegeWeight >= courseWeight ? "rc-lbl-active" : ""}`}>Better college</span>
              <span className={`rc-slider-lbl ${courseWeight > collegeWeight ? "rc-lbl-active" : ""}`}>Better course</span>
            </div>
            <input
              type="range"
              min="0"
              ...
              onChange={(e) => handleInputChange("preferenceWeight", Number(e.target.value))}
              className="rc-slider"
            />
              ...
              {branches.map((branch) => (
                ...
                >
                  {formData.preferredBranches.includes(branch) && (
                    <svg className="rc-chip-check" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M2 6l3 3 5-5" />
                    </svg>
                  )}
                  {branch}
        ...
        {error && (
          <div className="rc-error">
            <svg viewBox="0 0 16 16" fill="currentColor" className="rc-error-icon">
        ...
        {recommendations.length > 0 && (
          <div className="rc-results">
            <div className="rc-results-header">
              ...
              <span className="rc-results-count">{recommendations.length} matches found</span>
            </div>
                  ...
                  <div className="rc-result-details">
                    <div className="rc-details-grid">
                      ...
                      <div className="rc-detail-item">
                        ...
                        <span className="rc-detail-value">{rec.nirfRanking || "N/A"}</span>
                      </div>
                      <div className="rc-detail-item">
                      ...
                      <div className="rc-detail-item">
                        ...
                        <span className="rc-detail-value">₹{rec.fees?.toLocaleString() || "N/A"}</span>
                      </div>
                      <div className="rc-detail-item">
                        <span className="rc-detail-label">Avg package</span>
                        <span className="rc-detail-value">₹{rec.placement?.averagePackage?.toLocaleString() || "N/A"}</span>
                      </div>
                      <div className="rc-detail-item">
                        <span className="rc-detail-label">Highest package</span>
                        <span className="rc-detail-value">₹{rec.placement?.highestPackage?.toLocaleString() || "N/A"}</span>
                      </div>
                    </div>
                    <button
                      type="button"
                    ...
                    >
                      {explanationLoading ? (
                        ...
                        <svg viewBox="0 0 16 16" fill="currentColor" className="rc-ai-icon">
